...
$all_teachers = array_unique(array_column($assignments, 'teacher')); sort($all_teachers);
...
<thead><tr><th width="40"><input type="checkbox" id="check-all"></th><th>Giáo viên</th><th>Môn học</th><th>Lớp</th><th class="text-center">Số tiết</th><th>Ghi chú</th><th width="80"></th></tr></thead>
<tbody>
...
<tr>
    ...
    <td>
        <button type="submit" name="delete_id" value="<?= e($a['id']) ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Xóa?')"><i class="bi bi-trash"></i></button>
    </td>
</tr>
<?php endforeach; ?>
</tbody></table></div></div>
<div class="card-footer d-flex justify-content-between">
    <span class="text-muted small">Tổng: <?= count($filtered) ?> phân công</span>
