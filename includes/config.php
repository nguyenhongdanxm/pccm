...
// Danh mục kiêm nhiệm mặc định (need_class = cần chọn lớp, ví dụ GVCN)
$DEFAULT_ROLES = [
    ["name" => "GVCN", "need_class" => true, "note" => "Giáo viên chủ nhiệm"],
    ["name" => "TTCM", "need_class" => false, "note" => "Tổ trưởng chuyên môn"],
    ["name" => "TPCª", "need_class" => false, "note" => "Tổ phó chuyên môn"],
    ["name" => "Bí thư Đoàn", "need_class" => false, "note" => ""],
    ["name" => "Phó BT Đoàn", "need_class" => false, "note" => ""],
    ["name" => "Tổng phụ trách Đội", "need_class" => false, "note" => ""],
    ["name" => "Cố vấn học tập", "need_class" => false, "note" => ""],
    ["name" => "Phụ trách CSVC", "need_class" => false, "note" => ""],
    ["name" => "Phụ trách thư viện", "need_class" => false, "note" => ""],
    ["name" => "Phụ trách thiết bị", "need_class" => false, "note" => ""],
];
